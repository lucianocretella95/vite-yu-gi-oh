...
export default {
    data() {
        return {
            ...
            //         archetype: "Alien",
            //         ygoprodeck_url:
            //             "https://ygoprodeck.com/card/a-cell-recombination-device-7614",
            //         card_images: [
            //             {
            ...
            //         ygoprodeck_url:
            //             "https://ygoprodeck.com/card/infernoble-arms-durendal-10991",
            //         card_images: [
            //             {
            ...
            //         archetype: "Noble Knight",
            //         ygoprodeck_url:
            //             "https://ygoprodeck.com/card/infernoble-arms-hauteclere-10990",
            //         card_images: [
            //             {
...
<template>
    <div class="container text-center">
        <div class="column justify-content-start" style="font-size: 0.8rem;">
            <!-- <div class="col-4" v-for="carte in yugi">
                <p>{{ carte.name }} {{ carte.type }} {{ carte.desc }} {{ carte.archetype }}</p>
                <img style="width: 5rem;" :src="yugi[0].card_images[0].image_url">
            </div> -->
        </div>
    </div>
